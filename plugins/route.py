...
<head>
    ...
    <title>Warrior Units - Player is Live</title>
    <style>
        /* Basic reset */
        * {
            margin: 0;
...
<body>
    <!-- Main Content -->
    <div class="container">
        <div class="team-spy">Warrior Player</div>
        <div class="bot-status">⚡ Welcome to Warrior Player ⚡</div>

        <div class="actions">
            <a href="https://telegram.me/WarriorUnitsBots" class="btn">Join Telegram</a>
            <a href="https://telegram.me/oo7jatji" class="btn">Contact Admin</a>
        </div>
    </div>
</body>
</html>
